    ...
    <div className="section-stack">
      <section className="space-y-4">
        ...
        <p className="text-body text-text-secondary">
          ...
          der Nutzung der App &bdquo;Stirnraten&ldquo;.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Die App ist auf lokale Nutzung ausgelegt. Viele Daten werden ausschließlich lokal auf
          deinem Gerät gespeichert und nicht an uns übertragen.
        </p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Für die Generierung und Speicherung von KI-Wortlisten sowie serverseitige
          Schutzmechanismen nutzen wir Supabase (Datenbank, Authentifizierung, Edge Functions).
        </p>
        <ul className="list-disc space-y-1 pl-5 text-body text-text-secondary">
          ...
          <li>
            KI-Quota-Nutzung: Datumsschlüssel (Europe/Berlin) und Zähler (z. B. 3/Tag in Free)
          </li>
          <li>Premium-Status (serverseitiges Flag), um Limits durchzusetzen</li>
        </ul>
        <p className="text-body text-text-secondary">
          Die Daten werden pro Nutzer-ID gespeichert. Zugriffe sind technisch durch
          Zugriffskontrollen und Row-Level-Security auf eigene Daten beschränkt.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Wenn du eine KI-Wortliste generierst, wird eine serverseitige Supabase Edge Function
          aufgerufen. Diese prüft Quota/Premium-Status, generiert Begriffe und gibt eine bereinigte
          Wortliste zurück.
        </p>
        <p className="text-body text-text-secondary">
          Die eigentliche KI-Anfrage wird serverseitig an Groq übermittelt. Dabei werden in der
          Regel nur die von dir eingegebenen Inhalte (z. B. Thema, Sprache, Schwierigkeit,
          gewünschte Anzahl) übertragen. Bitte gib keine sensiblen oder personenbezogenen Daten als
          Thema/Prompt ein.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Premium-Funktionen werden über Apple App Store beziehungsweise Google Play abgewickelt.
          Zahlungsdaten (z. B. Kreditkartendaten) werden durch den jeweiligen Store verarbeitet.
        </p>
        <p className="text-body text-text-secondary">
          Zusätzlich nutzen wir RevenueCat zur Verwaltung von Käufen/Restores und zur Prüfung, ob
          Premium aktiv ist. Dafür werden notwendige technische Informationen zur Kaufabwicklung
          verarbeitet (z. B. Store-ID, Kaufstatus). Der Premium-Status kann serverseitig in Supabase
          gespiegelt werden, um Limits zuverlässig durchzusetzen.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Je nach Standort der jeweiligen Anbieter kann es zu einer Verarbeitung in Drittländern (z.
          B. USA) kommen. In diesen Fällen stützen wir die Übermittlung auf geeignete Garantien (z.
          B. EU-Standardvertragsklauseln), sofern erforderlich.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Lokal gespeicherte Daten verbleiben bis zur Löschung in der App oder bis zur
          Deinstallation. Cloud-Daten (z. B. KI-Listen, Quota) werden gespeichert, solange sie für
          die App-Funktionen erforderlich sind oder bis du sie löschst. Store-bezogene Daten werden
          durch Apple beziehungsweise Google nach deren Richtlinien verarbeitet.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          In der App werden keine Werbe-SDKs eingesetzt. Wir verwenden kein aggressives Tracking und
