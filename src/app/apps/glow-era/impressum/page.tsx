...
export const metadata: Metadata = {
  title: 'Impressum für Glow Era',
  description: 'Impressum für die mobile App Glow Era.',
  robots: {
    index: false,
    follow: false,
  },
...
export default function GlowEraImpressumPage() {
  return (
    <div className="section-stack">
      <section className="space-y-4">
        <h1>Impressum für Glow Era</h1>
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Elias Burk<br />
          Friedrich-Naumann Straße 11<br />
      ...
      <section className="space-y-3">
        <h2>2. Kontakt</h2>
        <p className="text-body text-text-secondary">
          E-Mail: <a href="mailto:eliasburk04@gmail.com">eliasburk04@gmail.com</a><br />
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          Es besteht keine Bereitschaft und keine Verpflichtung zur Teilnahme an
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          ...
          Seiten verantwortlich. Wir übernehmen jedoch keine Gewähr für die Aktualität,
      ...
      <section className="space-y-3">
        ...
        <p className="text-body text-text-secondary">
          ...
          Urheberrecht. Eine Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung
