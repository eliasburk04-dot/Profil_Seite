...
export const metadata: Metadata = {
  title: 'Impressum für EXPOSED – Party Game',
  description: 'Impressum für die mobile App EXPOSED – Party Game.',
  robots: {
    index: false,
    follow: false,
  },
...
export default function ExposedImpressumPage() {
  return (
    <div className="section-stack">
      <section className="space-y-4">
        <h1>Impressum für EXPOSED – Party Game</h1>
